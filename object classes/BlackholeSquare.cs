...
namespace Object_Classes {
    ...
    public class BlackholeSquare : Square {
        public int destination, fuelUsed;


        /// <summary>
        /// blackhole Square subclass constructor. Inherits name,
        /// number, next and fuel from Square base class.
        /// Constructor for destination position and fuel used for Blackhole
        /// </summary>
