...
namespace Game_Logic_Class
{
    public static class SpaceRaceGame
    {
        ...
        private static Die die1 = new Die(), die2 = new Die(); // The pair of die used for updating player locations.


        /// <summary>
        /// The getter and setter for the number of players who play the 
        /// space race game.
        /// </summary>
        ...
        /// <summary>
        ///  Plays one round of a game, given a set of dies. The dies are used to update player's location.
        ///  
        /// <param name="die1">The instance of one die.</param>
        /// <param name="die2">The instance of one die.</param>
        /// </summary>
        ...
        /// 
        /// This method takes two die, then calls the play method for
        /// that player, if they have power. 
        /// 
        /// <param name="count">The player number.</param>
        /// <param name="die1">The instance of one die.</param>
        /// <param name="die2">The instance of one die.</param>
        ///</summary>summary>
